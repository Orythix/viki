...
> Guides agents through container hardening and orchestration guardrails.

## Overview

Container and Orchestration provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with container hardening and orchestration guardrails.
...
- Confirm design decisions align with container hardening and orchestration guardrails.
