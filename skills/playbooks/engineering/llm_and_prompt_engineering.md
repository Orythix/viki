...
> Guides agents through eval-driven prompt and model operations.

## Overview

LLM and Prompt Engineering provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with eval-driven prompt and model operations.
...
- Confirm design decisions align with eval-driven prompt and model operations.
