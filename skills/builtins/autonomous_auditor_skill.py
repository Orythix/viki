...
class AutonomousAuditorSkill(BaseSkill):
    ...
    def description(self) -> str:
        return "Performs deep security/architectural audits of files. Actions: audit, security, arch."
    ...
    def schema(self) -> dict:
        return {
            ...
            "properties": {
                ...
                "path": {
                    "type": "string",
                    "description": "Path to the file or directory to audit"
                },
                "depth": {
                    "type": "string",
    ...
    async def _audit_file(self, file_path: str, focus: str, depth: str) -> str:
        try:
            ...
            if self._controller and hasattr(self._controller, "model_router"):
                viki_logger.info(f"AutonomousAuditor: Triggering heavy-tier deliberation for {file_path}...")
                ...
                model_name = "heavy" # Routing will handle it
