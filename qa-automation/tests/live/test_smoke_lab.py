"""
Live smoke tests against security-lab (FastAPI).

Run:
  cd security-lab/backend && set PYTHONPATH=.. && uvicorn app.main:app --port 8000
  cd qa-automation && set QA_LIVE_API=1 && set QA_API_KEY=dev-lab-change-me && pytest tests/live -m smoke -v
"""
