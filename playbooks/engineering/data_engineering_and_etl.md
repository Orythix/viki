...
> Guides agents through idempotent pipelines with quality and lineage checks.

## Overview

Data Engineering and ETL provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with idempotent pipelines with quality and lineage checks.
...
- Confirm design decisions align with idempotent pipelines with quality and lineage checks.
