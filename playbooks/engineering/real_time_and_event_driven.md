...
> Guides agents through event-driven delivery, ordering, and replay safety.

## Overview

Real-Time and Event-Driven provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with event-driven delivery, ordering, and replay safety.
...
- Confirm design decisions align with event-driven delivery, ordering, and replay safety.
