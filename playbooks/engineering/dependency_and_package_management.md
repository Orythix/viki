...
> Guides agents through dependency governance and supply-chain hygiene.

## Overview

Dependency and Package Management provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with dependency governance and supply-chain hygiene.
...
- Confirm design decisions align with dependency governance and supply-chain hygiene.
