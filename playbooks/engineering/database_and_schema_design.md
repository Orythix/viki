...
> Guides agents through schema design and migration safety.

## Overview

Database and Schema Design provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with schema design and migration safety.
...
- Confirm design decisions align with schema design and migration safety.
