...
from viki.core.evaluators import EvalScore, ExecutionEvaluator, LLMJudgeEvaluator
...
async def run_harness(
    ...
    table.add_row("Suite", str(summary["suite"]))
    ...
    table.add_row("Logs Path", str(summary["results_path"]))
