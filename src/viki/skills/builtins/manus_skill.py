...
from viki.core.execution_environment import SandboxResult, get_sandbox
...
class ManusSkill(BaseSkill):
    ...
    def description(self) -> str:
        return (
            "Autonomous task delivery agent. Executes workflows in a sandboxed Ubuntu environment."
        )
    ...
    def _read_skill_md(self, path: str) -> str | None:
    ...
    def _format_result(self, res: SandboxResult, task: str) -> str:
        ...
        report = [
            "--- Manus Autonomous Task Delivery ---",
            f"Task:    {task}",
