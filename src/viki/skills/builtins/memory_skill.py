...
class MemorySkill(BaseSkill):
    ...
    def schema(self) -> dict:
        return {
            ...
            "properties": {
                ...
                "category": {
                    "type": "string",
                    "description": "Category or source (e.g., 'coding', 'user_pref')",
                },
    ...
    async def _handle_stats(self) -> str:
        ...
        from viki.core.memory.database import get_connection
    ...
    async def _handle_sessions(self) -> str:
        ...
        for s in sessions:
            lines.append(
                f"- ID: {s['session_id'][:8]}... | Messages: {s['message_count']} | Last Active: {s['last_active']}"
            )
