...
```bash
# Tests
cd labs/security-lab && python -m pytest tests -q
...
# UI (dev)
cd labs/security-lab/frontend && npm install && npm run dev
```
...
Optional: use the repo’s **[`labs/qa-automation/`](../labs/qa-automation/)** tracks to practice API and UI automation against this API (see `labs/qa-automation/README.md`).
