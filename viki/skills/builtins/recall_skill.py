...
class RecallSkill(BaseSkill):
    ...
    def __init__(self, controller):
        ...
        self._name = "recall"
        self._description = "Perform a targeted search of your own long-term memory for specific facts. Usage: recall(query='What did sachin for Orythix001 say about Python?')"
