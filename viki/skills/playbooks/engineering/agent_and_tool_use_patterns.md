...
> Guides agents through planner-executor loops and tool safety controls.

## Overview

Agent and Tool Use Patterns provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with planner-executor loops and tool safety controls.
...
- Confirm design decisions align with planner-executor loops and tool safety controls.
