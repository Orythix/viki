...
> Guides agents through SemVer discipline and repeatable release flow.

## Overview

Release Engineering and Versioning provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with SemVer discipline and repeatable release flow.
...
- Confirm design decisions align with SemVer discipline and repeatable release flow.
