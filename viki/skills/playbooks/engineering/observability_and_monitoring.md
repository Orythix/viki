...
> Guides agents through telemetry, SLOs, and actionable alerting.

## Overview

Observability and Monitoring provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with telemetry, SLOs, and actionable alerting.
...
- Confirm design decisions align with telemetry, SLOs, and actionable alerting.
