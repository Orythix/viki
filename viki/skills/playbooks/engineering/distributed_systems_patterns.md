...
> Guides agents through distributed reliability under retries and partitions.

## Overview

Distributed Systems Patterns provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with distributed reliability under retries and partitions.
...
- Confirm design decisions align with distributed reliability under retries and partitions.
