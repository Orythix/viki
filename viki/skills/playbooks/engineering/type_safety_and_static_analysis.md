...
> Guides agents through type checks and static analysis quality gates.

## Overview

Type Safety and Static Analysis provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with type checks and static analysis quality gates.
...
- Confirm design decisions align with type checks and static analysis quality gates.
