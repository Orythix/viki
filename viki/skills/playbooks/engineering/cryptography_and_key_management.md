...
> Guides agents through vetted cryptography and key rotation operations.

## Overview

Cryptography and Key Management provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with vetted cryptography and key rotation operations.
...
- Confirm design decisions align with vetted cryptography and key rotation operations.
