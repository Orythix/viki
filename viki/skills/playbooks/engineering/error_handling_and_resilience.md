...
> Guides agents through explicit error taxonomy and graceful degradation.

## Overview

Error Handling and Resilience provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with explicit error taxonomy and graceful degradation.
...
- Confirm design decisions align with explicit error taxonomy and graceful degradation.
