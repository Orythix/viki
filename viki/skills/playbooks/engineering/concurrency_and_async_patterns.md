...
> Guides agents through concurrency control and cancellation-safe async flows.

## Overview

Concurrency and Async Patterns provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with concurrency control and cancellation-safe async flows.
...
- Confirm design decisions align with concurrency control and cancellation-safe async flows.
