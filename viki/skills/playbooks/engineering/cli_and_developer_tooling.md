...
> Guides agents through scriptable CLI contracts and safe operations.

## Overview

CLI and Developer Tooling provides production discipline for engineers who need predictable outcomes under real operational constraints.
...
1. **Frame domain concerns** - align scope with scriptable CLI contracts and safe operations.
...
- Confirm design decisions align with scriptable CLI contracts and safe operations.
